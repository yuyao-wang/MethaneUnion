...
def get_config(
    checkpoint_to_evaluate: Text,
    batch_size: int,
    dataset_config: Optional[dict] = None):
  """Return config object for training."""
  dataset_cfg = dataset.default_dataset_config()
  if dataset_config:
    dataset_cfg.update(dataset_config)
  train_images_per_epoch = dataset.count_examples(
      dataset_cfg['data_dir'],
      split=dataset.Split.TRAIN_AND_VALID,
      split_fractions=dataset_cfg.get('split_fractions'))
