...
def build_random_resnet18(in_ch, num_classes):
    model = tv_models.resnet18(weights=None)  # same as pretrained=False
...
if __name__ == '__main__':
    ...
    if config['model'] == 'ResNet18':
        ...
        model = build_random_resnet18(config['input_channel'], 1)
    ...
    #         if k.startswith('online_encoder.backbone.')
    #     }
    #     model.load_state_dict(backbone_state_dict, strict=False)
    # else:
    #     print('No pretrained checkpoint provided; training from random initialization.')
